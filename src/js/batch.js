...
$('#swapper').ready(() => {
    ...
    //#region Screen 1: General card info
    ...
    $('#bcc-new').on('openup', (_, key) => {
        ...
        genderSelect.listen('MDCSelect:change', () => { cards[key].gender = genderSelect.value.split('-')[1] })
    ...
    //#region Screen 3: Card generation
    ...
    //#region Screen 5: CTIS Generation
    $('#bcc-5').on('prep', () => {
